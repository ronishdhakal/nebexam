...
export default function ChapterPageClient() {
  ...
  const isClass12 = classSlug === 'class-12';
          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            {importantQuestions.length > 0 && (
              <div>
                ...
                {isFree && importantQuestions.length > FREE_PREVIEW_COUNT ? (
                  <div>
                    <QuestionTree questions={importantQuestions.slice(0, FREE_PREVIEW_COUNT)} hideMeta />
                    {/* Lock gate */}
                    <div className="relative mt-2">
                      {/* Blurred ghost of next items */}
                      <div className="pointer-events-none select-none blur-sm opacity-40">
                        <QuestionTree questions={importantQuestions.slice(FREE_PREVIEW_COUNT, FREE_PREVIEW_COUNT + 2)} hideMeta />
                      </div>
                      {/* Overlay */}
                        ...
                        <div className="flex flex-col items-center gap-3 py-6 px-4 text-center">
                          ...
                          <div>
                            <p className="text-sm font-bold text-slate-900 dark:text-white">
                              {importantQuestions.length - FREE_PREVIEW_COUNT} more question{importantQuestions.length - FREE_PREVIEW_COUNT !== 1 ? 's' : ''} locked
                            </p>
