...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Class ${level} Science Notes (Subject Wise) — NEB Exam`,
    description: `Class ${level} Science stream — chapter notes, past papers and model question sets for NEB exam preparation.`,
  };
}
...
export default async function SciencePage({ params }) {
  ...
  try {
    ...
    subjects = all.filter((s) => s.streams?.includes('science') || !s.streams?.length);
  } catch {}
